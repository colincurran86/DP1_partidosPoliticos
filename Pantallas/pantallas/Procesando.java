...
public class Procesando extends JPanel {
	...
	public void llamarNecesario() {
		
		Util u = new Util();
		MainRecorte m = new MainRecorte();
		
		m.procedimiento("D:\\Users\\jemarroquin\\git\\DP1_partidosPoliticos\\src\\Recorte\\Padrones");
		...
		u.llenarBDReniec("D:\\Users\\jemarroquin\\git\\DP1_partidosPoliticos\\src"
	...
	public void llamarRecortes() {
		 ...
		 * System.out.println("Inicio firmas:"); AlgoritmoFirmas algoritmoFrimas
		 * = new AlgoritmoFirmas();
		 * 
		...
		escribirTextArea("El tiempo total de ejecucion del programa fue "
				+ totalTime + " segundos");
