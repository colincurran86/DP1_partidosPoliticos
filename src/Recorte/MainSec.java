...
public class MainSec {
    ...
    public  void  main(String rutaPadrones  , PartidoPolitico pp, String rutaFirma, String rutaHuella) {
    	ProcesandoSeg.escribirLabelPartidoPolitico( "Iniciando recursos   :)   ");
    	ProcesandoSeg.escribirLabelPadron( "Espere por favor . . . ");
    	ProcesandoSeg.aumentarPorcentaje1(0);
    	Util u = new Util(); 
    	...
    	//	String formatearRutaBD = "D:\\Users\\jemarroquin\\git\\DP1_partidosPoliticos\\src\\registro.nacional.v.1.xlsx" ;
    		...
    		String formatearRutaBD = u.formatearRuta(segundaFase.rutaExcelSeg);
    		...
    		for (final File fileEntry : folder.listFiles()) { // abre cada planillon
    			...
    			ProcesandoSeg.escribirLabelPartidoPolitico( "Partido politico: " + pp.getNombre());
    			ProcesandoSeg.escribirLabelPadron ("Padron #"+ auxiliarBarraProgreso + " de " +  (folder.listFiles().length   ));
    			
    			int auxiliarBarraProgresoPlanillon  = 100 / (folder.listFiles().length + 1 ) ;
    			ProcesandoSeg.aumentarPorcentaje1 (auxiliarBarraProgreso  * auxiliarBarraProgresoPlanillon);
                ...
                for (int n  = 0; n < 8; n++){ // iterando en las filas     
                	...
                	ProcesandoSeg.aumentarPorcentaje1( (auxiliarBarraProgreso  * auxiliarBarraProgresoPlanillon ) +auxiliarBarraProgresoPlanillonFilas  );
                    ...
                    ProcesandoSeg.escribirTextArea("Se esta procesando el dni :"  + dni );
                     ...
                     */
                     ...
                     ProcesandoSeg.escribirTextArea("Cantidad de candidatos: " + listaPersonasReniec.size() );
                    ...
                    if(listaPersonasReniec.size() != 0 ) 
                    {
                        ...
                        int indiceCandidatoFirmas = candidatoFirmas(listaPorcentajeFirma);  
                     	for ( int i = 0 ; i < listaPersonasReniec.size() ; i++) 
                     		ProcesandoSeg.escribirTextArea("Para el candiato: " + listaPersonasReniec.get(i).getDni() + " Porcentaje de firmas es: "+ listaPorcentajeFirma.get(i) );     
                     	ProcesandoSeg.escribirTextArea( "De todos los candidatos el mejor según firmas es: " + listaPersonasReniec.get(indiceCandidatoFirmas).getDni());
                        ...
                        listaPorcentajeHuella = 	 AlgoritmoHuellas.procesarNuevo(listaPersonasReniec,AlgoritmoFirmas.huella,rutaHuella);
                      	...
                      	ProcesandoSeg.escribirTextArea( "De todos los candidatos el mejor según Huellas es: " + listaPersonasReniec.get(indiceCandidatoHuellas).getDni());
