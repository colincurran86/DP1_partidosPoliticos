...
public class AlgoritmoFirmas {
   ...
   */
    ...
    public int[] procesarr1(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 555;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c1" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr2(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 555;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c2" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr3(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 565;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c3" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr4(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 540;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c4" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr5(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 200;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c5" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr6(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 165;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c6" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr7(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 380;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c7" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr8(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 205;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c8" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr9(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 160;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c9" + cantidadPersonasProcesadas + ".jpg");
    ...
    public int[] procesarr10(boolean dibujarCorte,boolean  almacenarCorte,boolean dibujarPuntosCorte,boolean dibujarBaseDatos, boolean  dibujarPuntosBaseDatos,double umbral) {
        int[] idPersonasFalladas;
        int cantidadPersonasFalladas = 0;
        FastBitmap imagenCortada;
        int inicioX = 510;
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null, imagenCortada.toIcon(), "Resultado con Puntos", JOptionPane.PLAIN_MESSAGE);
            if(almacenarCorte)
            imagenCortada.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\c10" + cantidadPersonasProcesadas + ".jpg");
...
//   String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\"+isuperior+"j.jpg");
        //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\1\\c1"+isuperior+".jpg"); 
        //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\2\\c2"+isuperior+".jpg");
        //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\3\\c3"+isuperior+".jpg");
        //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\4\\c4"+isuperior+".jpg");
        //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\5\\c5"+isuperior+".jpg");
     //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\6\\c6"+isuperior+".jpg");
        //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\7\\c7"+isuperior+".jpg");
    //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\8\\c8"+isuperior+".jpg");
  //   String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\5\\c5"+isuperior+".jpg");
  //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\10\\c10"+isuperior+".jpg");
 // String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\6\\c61.jpg");
  ...
  //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\42r.jpg");
   //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\"+isuperior+"r.jpg");
       ...
       // String url1 = new String("C:\\Users\\LUIS S\\Desktop\\f\\"+isuperior+".jpg");
  ...
  /*      
    ...
    */
        ...
        //System.out.println("Tama�o: "+descriptores1.size());
        //System.out.println("Tama�o 1: "+imagen1.getWidth()+" "+imagen1.getHeight());
  ...
  // String url2 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\37.jpg");    
...
//        BufferedImage scaledImg = Scalr.resize(img, Method.BALANCED, imagen1.getWidth(), imagen2.getHeight(),Scalr.OP_ANTIALIAS);       
       ...
       */ 
        ...
        //BufferedImage bi = Thumbnails.of(new File("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\37.jpg"))
        .size(imagen1.getWidth(), imagen1.getHeight())
        .outputFormat("JPG")
        .outputQuality(1)
        .resizer(Resizers.PROGRESSIVE)
...
//             BufferedImage scaledImg = Scalr.resize(img, Method.BALANCED, imagen1.getWidth(), imagen2.getHeight(),Scalr.OP_ANTIALIAS);       
      ...
      //  BufferedImage scaledImg = Scalr.resize(img, Method.QUALITY, 
        ...
        //System.out.println("Tama�o de 2: "+imagen2.getWidth()+" "+imagen2.getHeight());
...
*/    
   ...
   */
    ...
    public List<Resultado> verificarFirmas7(List<Integer> idPersonas,List<String> idFirmas,List<BufferedImage> listFirmas, String direccionBaseDatosFirmas, List<FastBitmap> lf) throws IOException
    {
    ...
    public void verificarFirmas9()
    {
    	...
    	for (int i = 1; i < 2; i++) {
	     ...
	     //   FastBitmap imagen2 = new FastBitmap("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\rayado_Modificados_v1.jpg");
    		//FastBitmap imagen2 = new FastBitmap("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\"+i+".jpg");
    		
    		FastBitmap imagen2 = new FastBitmap("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\2.jpg");
    	   
    		//Firmas.FastBitmap pp= new FastBitmap("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\5.jpg");
    	   //pp.getGrayData();
    		//0 negro; 255 blanco
    		   Rotate rotarImage = new Rotate(90.0, Rotate.Algorithm.BILINEAR);
	        ...
	        OtsuThreshold o = new OtsuThreshold();
	        o.applyInPlace(imagen2);	        
	        //JOptionPane.showMessageDialog(null, imagen2.toIcon(), "Result con Puntos", JOptionPane.PLAIN_MESSAGE);
	        
	        imagen2.saveAsJPG("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\"+i+"r.jpg");
	 ...
	 int primero =0;
	      ...
	      //if(isuperior!=3273 && isuperior!=3274 && isuperior!=3275 && isuperior!=3276 && isuperior!=3277&& isuperior!=3278&& isuperior!=3279&& isuperior!=3280){
	    	  for (int j = 0; j < imagen2.getHeight(); j++) { 
	        	...
	        	//if(isuperior==3222)
	        	//System.out.println("is: "+isuperior+" k: "+j+" gray:"+imagen2.getGray(j,isuperior));	
...
//System.out.println("holasda");
    ...
    public ArrayList<FirmaRecortada> verificarFirmas10()
    {
		...
		System.out.println("1111..................."+i);
	     //   FastBitmap imagen2 = new FastBitmap("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\rayado_Modificados_v1.jpg");
   FastBitmap imagen2 = new FastBitmap("C:\\Users\\alulab14.INF.001\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\"+i+".jpg");
   ...
   if(imagen2.getWidth()<imagen2.getHeight())
   {
       ...
       objetoCortador = new Crop(0,imagen2.getWidth()/2,imagen2.getWidth()/2+imagen2.getWidth()/3,ig-10);
   ...
   else
   {
       ...
       //objetoCortador = new Crop(0,0,imagen2.getWidth(),imagen2.getHeight()/5);
	    ...
	    //    o.applyInPlace(imagen2);	  
	        ...
	        //imagen2.saveAsJPG("//home//wirox91//Escritorio//Nueva carpeta//Firmas Java//Otras_Resoluciones//objs//planillon//"+i+"r.jpg");
	        imagen2.saveAsJPG("C:\\Users\\alulab14.INF.001\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon"+i+"r.jpg");
	       ...
	       /* int inn=0;
	        ...
	        for (int k = imagen2.getHeight()-1; k >0; k--) {
	        	...
	        	if(imagen2.getGray(k, imagen2.getWidth()/2)==0){
	        		inn=k;
	        	//break;
	        	}
	        }
	      ...
	      //  System.out.println("in "+inn);
	       ...
	       /*
		     ...
		     int in = imagen2.getWidth()-1;
		    int cf=0; 
		     for (int k = 0; k < imagen2.getHeight()-1; k++) {
			if(imagen2.getGray(k, in)==0)
				cf++;
	  ...
	  //      int ind = imagen2.getWidth()-50;
	        ...
	        */
	        ...
	        ind=t1;
	        // ArrayList<ArrayList<Resultado>> a3 =  new ArrayList<ArrayList<Resultado>();
	 ...
	 //  for (j = inn+10; j > 0 ; j--) {
	  ...
	  // for (j = inn+10; j > 0 ; j--) {
		...
		/*  
		  ...
		  else if (imagen2.getGray(j, ind)==0)
		  {	  //pasoPrimerNegro=j;
		   		c++;
		  }		 
	*/
	   ...
	   ind--;
	    ...
	    // for (int k = ig-1; k >0 ; k--) {
	     ...
	     int veces=0;
	       ...
	       //Extra
	       /*
	       for (int k = talto2; k >0; k--) {
			int cgg=0;
	    	   for (int k2 = 0; k2 < ancho; k2++) {
				if(imagen2.getGray(k, k2)==0)
					cgg++;
				if(cgg>=ancho/2)
					break;
			}
	...
	if(veces==8) break;
		    	 ...
		    	 //Extra
		    /*	 if(band1==1)
				     for (int ij = k; ij > 0 ; ij--) {
				    	 int cv=0;
				    	 int pasoFor=0;
				    	 for(int jh=tmp1;tmp1<tmp2;jh++)
				    	 {
				    		 if(imagen2.getGray(ij, jh)==0)
				    			 cv++;
				    		 if(cv>=ancho/2) 
				    		 {  pasoFor=1;
				    			 break;}
		...
		System.out.println("Linea actual ..........."+k);
		      ...
		      imagen2.saveAsJPG("C:\\Users\\alulab14.INF.001\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\"+i+"rr.jpg");
		      FastBitmap i3 =  new FastBitmap("C:\\Users\\alulab14.INF.001\\Desktop\\Nueva carpeta\\Firmas Java\\Otras_Resoluciones\\objs\\planillon\\"+i+"rr.jpg");
		      //i3 = imagen2;
		   ...
		   System.out.println("alto: "+alto); 	 
	        ...
	        /*
	        for (int k = ind; k > imagen2.getWidth()-206; k--) {
	        //	al =  new ArrayList<Resultado>();
	        	cont=0;
	        for (int j = 0; j < imagen2.getHeight()-1; j++) {
    ...
    void procesar3(ArrayList<FirmaRecortada> lbi) throws IOException
    {	//double umbral=85;
    	double umbral=5;
    	int d1 = 0,d2=0;
 ...
 // String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\cc\\6\\c61.jpg");
  ...
  //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\42r.jpg");
   //String url1 = new String("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\"+isuperior+"r.jpg");
       ...
       // String url1 = new String("C:\\Users\\LUIS S\\Desktop\\f\\"+isuperior+".jpg");
        ...
        descriptores1 = freak1.ProcessImage(imagen1);
	      JOptionPane.showMessageDialog(null, imagen1.toIcon(), "Result "+isuperior+" ", JOptionPane.PLAIN_MESSAGE);
  ...
  /*      
    ...
    */
      ...
      String url2 = new String("C:\\Users\\alulab14.INF.001\\Desktop\\Nueva carpeta\\Firmas Java\\"+ind+".jpg");
...
//        BufferedImage scaledImg = Scalr.resize(img, Method.BALANCED, imagen1.getWidth(), imagen2.getHeight(),Scalr.OP_ANTIALIAS);       
       ...
       */ 
        ...
        if(ancho<=1300 && alto<=1300){
          bi = Thumbnails.of(new File("C:\\Users\\alulab14.INF.001\\Desktop\\Nueva carpeta\\Firmas Java\\"+ind+".jpg"))
        //BufferedImage bi = Thumbnails.of(new File("C:\\Users\\LUIS S\\Desktop\\Nueva carpeta\\Firmas Java\\37.jpg"))
        .size(imagen1.getWidth()-22, imagen1.getHeight()-22)
        .outputFormat("JPG")
        .outputQuality(1)
        .resizer(Resizers.PROGRESSIVE)
        .asBufferedImage();
        ...
        //	}
  	     ...
  	     // JOptionPane.showMessageDialog(null, imagen2.toIcon(), "Result "+isuperior+" ", JOptionPane.PLAIN_MESSAGE);  		
       	System.out.println("1Image1: "+imagen1.getWidth()+" "+imagen1.getHeight());
            System.out.println("1Image2: "+imagen2.getWidth()+" "+imagen2.getHeight());
        }
        else
        ...
        */
        ...
        for(int i = 0; i < descriptores1.size(); i++){
           // distanciaMinima=0;
            ...
            for(j = 0; j < descriptores2.size(); j++)
            {  
            	if(descriptores1.get(i).primerosBits(descriptores2.get(j))>=distanciaFiltro){ //20 no falla 34, 5 DEFAULT , 14 default
            		//15, falla 14
            		//10, falla 10
            		//5, falla 10
            		//14 , falla 12 en total
